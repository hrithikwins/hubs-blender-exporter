...
class SitPoint(HubsComponent):
    _definition = {
        'name': 'sit-point',
        'display_name': 'Sit Point',
        'category': Category.ELEMENTS,
        'node_type': NodeType.NODE,
        'panel_type': [PanelType.OBJECT, PanelType.BONE],
        # waypoint gizmos  is still being used here
        'gizmo': 'waypoint',
        'icon': 'sit-point.png',
        'deps': ['networked'],
        'version': (1, 0, 0)
    ...
    canBeClicked: BoolProperty(
        name="Clickable",
        description="This sitpoint will be visible in pause mode and clicking on it will teleport you to it",
        default=True)
